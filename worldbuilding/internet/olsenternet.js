const olsenPages = {
    ...
    lost: "<p>Looks like you're lost. I'm sorry you ended up here. If you're really struggling, "
    ...
    died: "<h2>Died</h2><p>Something interesting happens when you die. It's like when everything you've built becomes some limited, collector's edition item that a fifty-year-old man keeps in his basement. "
    ...
    guest: "<h2>Guest</h2><p>Welcome, my guest, my humble interested visitor, my explorer of corners of the internet. Maybe you're somebody I know. Maybe you're somebody I don't. Maybe you're me. Maybe you're my ghost, trying to remember how you died. "
        + "In any case, I hope you feel welcome. This place rules, and I'd absolutely hate if you didn't enjoy your time here.",
    rules: "<h2>Rules</h2><p>Welcome to my corner of the internet. I lied. We have very strict rules.</p>"
    ...
    secret_link: "<h2>Secret Link</h2><p>Link, link, on the site;<br/>Who was the face on TV, live?</p>"
    ...
    link: "<h2>Link</h2><p>Links are weird tunnels through time and space. I find it so easy to get lost.</p>",
    life: "<h2>Life</h2><p>Life is horribly temporary. There's some shame in the fact that it doesn't last forever.<br/> "
