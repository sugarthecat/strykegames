const olsenPages = {
    ...
    friends: "<h2>Friends</h2><p><i>A list of people.</i></p><p>Everybody calls everybody their friend, and I think I should make my list short and meaningful. No, just because we're friends on Skokal doesn't mean we're friends here."
        + " So here, all my friends (if they're on Skokal) are listed by their Skokal username. Just because you aren't on here doesn't mean I don't like you. You know, you're cool, maybe we're just not close. </p>"
        + "<ul>"
