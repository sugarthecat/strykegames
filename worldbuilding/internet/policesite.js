const policePages = {
    ...
    + "<p><b>Anomymous2</b></p>"
    + "<p>14 mins ago</p>"
    + "<p>My theory's wrong - Kid escaping isn't a match for the wrecked car owner. He told me some guy he knew started this fire and locked himself in the shed. Some kid by the initials F.O. (not breaking rules, admin, right?) </p>"
    + "<hr/>"
    + "<p><b>Anomymous2</b></p>"
    + "<p>20 mins ago</p>"
    ...
    + "<p><b>Anomymous1</b></p>"
    + "<p>1 hour ago</p>"
    + "<p>Police are here. Seems like that's all I can really document</p>"
    + "<hr/>"
    + "<p><b>Anomymous1</b></p>"
    + "<p>3 hours ago</p>"
